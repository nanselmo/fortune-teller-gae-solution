...
class FortuneHandler(webapp2.RequestHandler):
    def get(self):
        start_template=current_directory.get_template("templates/fortune_welcome.html")
    ...
    def post(self):
        ...
        end_template=current_directory.get_template("templates/fortune_results.html")
